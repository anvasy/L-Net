    ...
    protected void doPost(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        try(DataBase dataBase = new DataBase()) {
            ...
            if(ratesDAO.ifRated(userId, Integer.valueOf(articleId))) {
                ...
                out.println("<script type=\"text/javascript\">alert('You already rated this article.');location='home';\"</script>");
            } else {
                Rate rate = new Rate();
                ...
                new ArticleDAO(dataBase).updateRate(Integer.valueOf(httpServletRequest.getParameter("rated")), Integer.valueOf(articleId));
                httpServletResponse.sendRedirect("home");
            }
